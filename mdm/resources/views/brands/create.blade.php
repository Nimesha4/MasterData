{{-- filepath: resources/views/brands/create.blade.php --}}
@extends('layouts.app')
    ...
    <div class="form-content">
        <div class="form-card">
            <div class="form-header-card">
                <h2 class="form-subtitle">Create Brand</h2>
                <p class="form-description">Add a new brand to organize your products and expand your inventory catalog</p>
            </div>
                ...
                <form action="{{ route('brands.store') }}" method="POST">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group full-width status-section">
                            ...
                            <div class="field-help">Choose whether this brand should be available for use</div>
                        </div>
                    </div>
