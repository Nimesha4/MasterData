    ...
    <div class="brands-content">
        ...
        <div class="action-header">
            ...
            <div style="display:flex;gap:0.5rem;">
                <a href="{{ route('brands.export', array_merge(request()->all(), ['type'=>'csv'])) }}" class="btn-add" style="background:linear-gradient(135deg,#4299e1,#63b3ed);padding:0.35rem 0.8rem;font-size:0.8rem;"><span style="font-size:1em;">⬇️</span> Export CSV</a>
