                    ...
                    <form action="{{ route('categories.update', $category->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select name="status" id="status" class="form-control form-select">
                                <option value="Active" {{ $category->status=='Active'?'selected':'' }} class="status-option status-active">
                                    ✅ Active
                                </option>
                                <option value="Inactive" {{ $category->status=='Inactive'?'selected':'' }} class="status-option status-inactive">
                                    ❌ Inactive
                                </option>
                            </select>
                        </div>
