...
<style>
    ...
    .categories-table-container::before {
        content: '';
        position: absolute;
        top: 0;
        left: 0;
...
<div class="categories-container">
    ...
    <div class="categories-content">
        ...
        <div class="action-header">
            ...
            <form method="GET" action="{{ route('categories.index') }}" style="display:flex;gap:1rem;align-items:center;">
                ...
                <table class="categories-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="status-badge {{ strtolower($category->status) == 'active' ? 'status-active' : 'status-inactive' }}">
                                    {{ $category->status }}
                                </span>
                            </td>
                            <td>
        ...
        @else
            <div class="empty-state">
                ...
                <div class="empty-subtext">Start by creating your first category to organize your products!</div>
            </div>
        @endif
    </div>
</div>
